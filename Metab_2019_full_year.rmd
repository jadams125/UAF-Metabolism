---
title: "2019_metab_8000BI_1500Saved_FULL_YEAR"
author: "Jacob Adams"
date: "2023-01-09"
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2019-Run_2023-01-18_full.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2019-Run_2023-01-18_full.csv"))
