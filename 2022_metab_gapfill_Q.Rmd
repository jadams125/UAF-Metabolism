...
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG,PanLight, size="max"))
ggsave(path = here("outputs"), file = "poke2022_gapfill_q_full.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "strt2022_gapfill_q_full.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2022_gapfill_q_full.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2022_gapfill_q_full.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
