...
data.poke.mm.all$light <-  calc_light(data.poke.mm.all$solar.time, 64.75408, -146.479933)

data.poke.mm.all$time <- format(as.POSIXct(data.poke.mm.all$solar.time), format = "%H:%M:%S") 


data.poke.mm.all <- data.poke.mm.all %>% mutate(light = replace(light, time >"16:00:00" & time < "23:59:00", 0))
...
mm.test.poke <- metab(bayes_specs, data= na.omit(data.poke.mm.all))
endTime <- as.POSIXct(Sys.time())
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2022-Run_2023-01-19_gapfillQ.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2022-Run_2023-01-19_gapfillQ.csv"))
...
L.fig <- ggplot(data = model_data, aes(x = solar.time)) +geom_point(aes(y=light), color = "slateblue4", size=0.4)+ theme(axis.title.x=element_blank() )+ labs(y = "Light")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme(axis.text.y=element_text(size=20))+theme(axis.text.x=element_text(size=20))+theme( axis.title.y = element_text(size = 20))
...
PanLight <- ggplotGrob(L.fig)
grid::grid.newpage()
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,PanLight,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG,PanLight, size="max"))
ggsave(path = here("outputs"), file = "poke2022_gapfill_q_full.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("Moose 2022")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
ggsave(path = here("outputs"), file = "moos2022_gapfill_q_full.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
startTime <- as.POSIXct(Sys.time())
mm.test.strt <- metab(bayes_specs, data= na.omit(data.strt.mm.all))
endTime <- as.POSIXct(Sys.time())
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2022-Run_2023-01-19_gapfillQ.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2022-Run_2023-01-19_gapfillQ.csv"))
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("stuart 2022")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "strt2022_gapfill_q_full.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.frch.mm.all$light <-  calc_light(data.frch.mm.all$solar.time, 64.75408, -146.479933)
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2022-Run_2023-01-19_gapfillQ.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2022-Run_2023-01-19_gapfillQ.csv"))
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("french 2022")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2022_gapfill_q_full.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.vaul.mm.all$light <-  calc_light(data.vaul.mm.all$solar.time, 64.75408, -146.479933)
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2022-Run_2023-01-19_gapfillQ.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2022-Run_2023-01-19_gapfillQ.csv"))
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("vault 2022")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2022_gapfill_q_full.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
bayes_specs <- specs(bayes_name,
                     burnin_steps=3000, saved_steps=1500, n_cores=4,
                     GPP_daily_lower = 0, ER_daily_upper = 0,
