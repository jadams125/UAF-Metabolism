...
dat_night <- PCmet %>% mutate(solar.time = as.POSIXct(solar.time, tz = "UTC"))%>%  mutate(light=if_else(hour(solar.time) %in% c(0:5,20:24), 0, light)  )
...
poke.2019 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("poke.2019 Gerard Code Nightime Regression")
poke.2019
...
#comparison of the K nodes and the NTR data
poke.2020 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("poke.2020 Gerard Code Nightime Regression")
poke.2020
...
#comparison of the K nodes and the NTR data
poke.2021 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("poke.2021 Gerard Code Nightime Regression")
poke.2021
...
#comparison of the K nodes and the NTR data
vaul.2019 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("vaul.2019 Gerard Code Nightime Regression")
vaul.2019
...
data.poke.mm.all <- read.csv(here("outputs", "clean.vaul.2020.full.csv"))
...
#comparison of the K nodes and the NTR data
vaul.2020 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("vaul.2020 Gerard Code Nightime Regression")
vaul.2020
...
data.poke.mm.all <- read.csv(here("outputs", "clean.vaul.2021.full.csv"))
...
#comparison of the K nodes and the NTR data
vaul.2021 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("vaul.2021 Gerard Code Nightime Regression")
vaul.2021
...
data.poke.mm.all <- read.csv(here("outputs", "clean.vaul.2022.full.csv"))
...
#comparison of the K nodes and the NTR data
vaul.2022 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("vaul.2022 Gerard Code Nightime Regression")
vaul.2022
...
data.poke.mm.all <- read.csv(here("outputs", "clean.frch.2019.full.csv"))
...
#comparison of the K nodes and the NTR data
frch.2019 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("frch.2019 Gerard Code Nightime Regression")
frch.2019
...
data.poke.mm.all <- read.csv(here("outputs", "clean.frch.2020.full.csv"))
...
#comparison of the K nodes and the NTR data
frch.2020 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("frch.2020 Gerard Code Nightime Regression")
frch.2020
...
data.poke.mm.all <- read.csv(here("outputs", "clean.frch.2021.full.csv"))
...
#comparison of the K nodes and the NTR data
frch.2021 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("frch.2021 Gerard Code Nightime Regression")
frch.2021
...
data.poke.mm.all <- read.csv(here("outputs", "clean.frch.2022.full.csv"))
...
#comparison of the K nodes and the NTR data
frch.2022 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("frch.2022 Gerard Code Nightime Regression")
frch.2022
...
data.poke.mm.all <- read.csv(here("outputs", "clean.moos.2019.full.csv"))
...
#comparison of the K nodes and the NTR data
moos.2019 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("moos.2019 Gerard Code Nightime Regression")
moos.2019
...
data.poke.mm.all <- read.csv(here("outputs", "clean.moos.2020.full.csv"))
...
#comparison of the K nodes and the NTR data
moos.2020 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("moos.2020 Gerard Code Nightime Regression")
moos.2020
...
data.poke.mm.all <- read.csv(here("outputs", "clean.moos.2021.full.csv"))
...
#comparison of the K nodes and the NTR data
moos.2021 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("moos.2021 Gerard Code Nightime Regression")
moos.2021
...
data.poke.mm.all <- read.csv(here("outputs", "clean.moos.2022.full.csv"))
...
#comparison of the K nodes and the NTR data
moos.2022 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("moos.2022 Gerard Code Nightime Regression")
moos.2022
...
data.poke.mm.all <- read.csv(here("outputs", "clean.strt.2019.full.csv"))
...
#comparison of the K nodes and the NTR data
strt.2019 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("strt.2019 Gerard Code Nightime Regression")
strt.2019
...
data.poke.mm.all <- read.csv(here("outputs", "clean.strt.2020.full.csv"))
...
#comparison of the K nodes and the NTR data
strt.2020 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("strt.2020 Gerard Code Nightime Regression")
strt.2020
...
data.poke.mm.all <- read.csv(here("outputs", "clean.strt.2021.full.csv"))
...
#comparison of the K nodes and the NTR data
strt.2021 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("strt.2021 Gerard Code Nightime Regression")
strt.2021
...
data.poke.mm.all <- read.csv(here("outputs", "clean.strt.2022.full.csv"))
...
#comparison of the K nodes and the NTR data
strt.2022 <- ggplot()+ geom_point(data=K600_nights_PC, aes(discharge, K600.daily))+
  geom_pointrange(data = pred_K_NPC, aes(x=discharge, y=K.600.fit,ymin=K.600.fit-K.600.se.fit,
                                         ymax=K.600.fit+K.600.se.fit ), color='red')+ggtitle("strt.2022 Gerard Code Nightime Regression")
strt.2022
