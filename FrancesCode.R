...
q.min<-log(min(data.strt.mm.all$discharge))
q.max<-log(max(data.strt.mm.all$discharge))
...
save(mm.test.strt, file = here("Outputs", "stuart2019-Run_2023-FC.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2019-Run_2023-FC.csv"))
...
ggsave(path = here("outputs"), file = "strt2019-FC.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2020-Run_2023-FC.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2020-Run_2023-FC.csv"))
...
ggsave(path = here("outputs"), file = "strt2020-FC.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2021-Run_2023-FC.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2021-Run_2023-FC.csv"))
...
ggsave(path = here("outputs"), file = "strt2021-FC.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2022-Run_2023-FC.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2022-Run_2023-FC.csv"))
...
ggsave(path = here("outputs"), file = "strt2022-FC.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
#####DISCHARGE NODES FOR BINNED K600 POOLING#####
q.min<-log(min(data.vaul.mm.all$discharge))
q.max<-log(max(data.vaul.mm.all$discharge))
nodes<-c(seq(q.min, q.max, by=(q.max-q.min)/5)) #end up with six evenly spaced nodes
node.dev<-(q.max-q.min)/10 #half the difference between centers. use for nodediffs_sd in model specs
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2019-Run_2023-FC.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2019-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2019-FC.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2020-Run_2023-FC.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2020-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2020-FC.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2021-Run_2023-FC.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2021-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2021-FC.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2022-Run_2023-FC.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2022-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2022-FC.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
#####DISCHARGE NODES FOR BINNED K600 POOLING#####
q.min<-log(min(data.poke.mm.all$discharge))
q.max<-log(max(data.poke.mm.all$discharge))
nodes<-c(seq(q.min, q.max, by=(q.max-q.min)/5)) #end up with six evenly spaced nodes
node.dev<-(q.max-q.min)/10 #half the difference between centers. use for nodediffs_sd in model specs
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2019-Run_2023-FC.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2019-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2019-FC.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2020-Run_2023-FC.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2020-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2020-FC.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2021-Run_2023-FC.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2021-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2021-FC.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2022-Run_2023-FC.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2022-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2022 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2022-FC.pdf", fig2022, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2019-Run_2023-FC.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2019-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2019-FC.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2020-Run_2023-FC.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2020-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2020-FC.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2021-Run_2023-FC.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2021-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2021-FC.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2019-Run_2023-FC.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2019-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2019-FC.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2020-Run_2023-FC.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2020-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2020-FC.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2021-Run_2023-FC.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2021-Run_2023-FC.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2021-FC.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
