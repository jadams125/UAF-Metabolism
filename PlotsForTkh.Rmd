...
plot2019 <- metab_all %>% filter(year=="2019")%>%  ggplot(aes(x=site, y=GPP_mean)) + facet_wrap(~year, nrow = 2, dir = "v")+ geom_boxplot(aes(fill=as.factor(PF)),show.legend = FALSE) +
...
plot2020 <- metab_all %>% filter(year=="2020")%>%  ggplot(aes(x=site, y=GPP_mean)) + facet_wrap(~year, nrow = 2, dir = "v") + geom_boxplot(aes(fill=as.factor(PF)))+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2021 <- metab_all %>% filter(year=="2021")%>%  ggplot(aes(x=site, y=GPP_mean)) + facet_wrap(~year, nrow = 2, dir = "v") + geom_boxplot(aes(fill=as.factor(PF)), show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2022 <- metab_all %>% filter(year=="2022")%>%  ggplot(aes(x=site, y=GPP_mean)) + facet_wrap(~year, nrow = 2, dir = "v") +  geom_boxplot(aes(fill=as.factor(PF)), show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
metab_all.short <- metab_all %>% select(date, ER_mean, ER_daily_se_mean, ER_daily_sd, ER_Rhat, site)
...
plot2019 <- metab_all %>% filter(year=="2019")%>%  ggplot(aes(x=site, y=ER_mean)) + facet_wrap(~year, nrow = 2, dir = "v")+ geom_boxplot(aes(fill=as.factor(PF)),show.legend = FALSE) +
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2020 <- metab_all %>% filter(year=="2020")%>%  ggplot(aes(x=site, y=ER_mean)) + facet_wrap(~year, nrow = 2, dir = "v") + geom_boxplot(aes(fill=as.factor(PF)),show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2021 <- metab_all %>% filter(year=="2021")%>%  ggplot(aes(x=site, y=ER_mean)) + facet_wrap(~year, nrow = 2, dir = "v") + geom_boxplot(aes(fill=as.factor(PF)), show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2019 <- metab_all %>% filter(year=="2019")%>%  ggplot(aes(x=site, y=NEP_mean)) + facet_wrap(~year, nrow = 2, dir = "v") +geom_hline(yintercept=0,linetype=2)+geom_boxplot(aes(fill=as.factor(PF)),show.legend = FALSE) +
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2020 <- metab_all %>% filter(year=="2020")%>%  ggplot(aes(x=site, y=NEP_mean)) + facet_wrap(~year, nrow = 2, dir = "v")  +geom_hline(yintercept=0,linetype=2)+geom_boxplot(aes(fill=as.factor(PF)))+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2021 <- metab_all %>% filter(year=="2021")%>%  ggplot(aes(x=site, y=NEP_mean)) + facet_wrap(~year, nrow = 2, dir = "v")+geom_hline(yintercept=0,linetype=2) + geom_boxplot(aes(fill=as.factor(PF)), show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
plot2022 <- metab_all %>% filter(year=="2022")%>%  ggplot(aes(x=site, y=NEP_mean)) + facet_wrap(~year, nrow = 2, dir = "v") +geom_hline(yintercept=0,linetype=2)+ geom_boxplot(aes(fill=as.factor(PF)), show.legend = FALSE)+
  facet_grid(. ~ burn , space="free_x", scales="free_x", switch="x") +
  theme_classic() +
  theme(strip.placement = "outside",
        strip.background = element_rect(fill=NA, colour="grey50"),
...
# GPP_Poke <- metab_all %>% filter(site =="POKE")
