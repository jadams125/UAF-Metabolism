...
er_k <- ggplot(data=fit.daily, aes(x=ER_mean, y=K600_daily_mean)) + geom_point()+ stat_poly_line() + stat_poly_eq()
...
grid::grid.newpage()
grid.draw(rbind(panA, panB, panC, panD,panE,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB, panC, panD,panE,panF,panG, size="max"))
