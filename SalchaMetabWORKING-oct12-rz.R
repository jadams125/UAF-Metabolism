...
Salcha.exo.2021 <- read.csv(file=file.path("C:/Users/jadams125/Documents/GitHub/Salcha/EXO_processed/SALCHA.EXO.cl.corr.2021.csv"))

ts_2021 <- read.csv("C:/Users/jadams125/Documents/GitHub//UAF-Metabolism/ts_2021.csv")

# setwd("C:/Users/jadams125/Documents/GitHub//Salcha/EXO_data/from_internal_harddrive/")

test <- full_join(ts_2021, Salcha.exo.2021, by = "datetimeAK")

write.csv(test, "C:/Users/jadams125/Documents/GitHub//UAF-Metabolism/salcha.2021.full.ts.csv")

setwd("C:/Users/jadams125/Documents/GitHub//")
...
CRREL <- read.csv("C:/Users/jadams125/Documents/GitHub//UAF-Metabolism/Crell_met_PAR.csv", skip = 5)
...
write.csv(CRREL_SALCHA1, "C:/Users/jadams125/Documents/GitHub//UAF-Metabolism/Crell_met_PAR2.csv")
...
write.csv(dischargeSalcha, ("C:/Users/jadams125/Documents/GitHub//UAF-Metabolism/q_data.csv"))
...
save(mm.test.salcha.new, file = (here("Outputs","salcha.2021.oct12model.1.RData")))
...
q.fig <- ggplot(data = salchaData, aes(x = solar.time)) +geom_point(aes(y=discharge))
grid.newpage()
