...
ts_2019.moos <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2019-05-31 15:45"),ymd_hm("2019-10-22 07:15"), by = '15 mins')), tz = "America/Anchorage"))
...
clean <- MOOS.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new) %>% 
   filter(n()<48) %>% 
...
clean1 <- clean %>% filter(as.character(datetimeAK)< "2019-07-08 12:45:00")
clean2 <- clean %>% filter(as.character(datetimeAK) >"2019-07-09 09:30:00")

cleanAdjust <- clean %>% filter(as.character(datetimeAK)>= "2019-07-08 12:45:00"& as.character(datetimeAK) <="2019-07-09 09:30:00")

cleanAdjust$discharge = NA
cleanAdjust$depth = NA

cleanTest <- rbind(clean1, cleanAdjust, clean2)

#linear fill
clean3 <- cleanTest %>% filter(as.character(datetimeAK)< "2019-07-08 10:45:00")
clean4 <- cleanTest %>% filter(as.character(datetimeAK) >"2019-07-09 11:30:00")

cleanTestFill <- cleanTest %>% filter(as.character(datetimeAK)>= "2019-07-08 10:45:00"& as.character(datetimeAK) <="2019-07-09 11:30:00")

cleanTestFill$depth <- na_kalman(cleanTestFill$depth,type = "level")
cleanTestFill$discharge <- na_kalman(cleanTestFill$discharge, type = "level")


cleanTest <- rbind(clean3, cleanTestFill, clean4)
...
cleaning.temp1 <- clean %>% filter(solar.time<="2019-09-15")
cleaning.temp2 <- clean %>% filter(solar.time> "2019-09-15")


cleaning.temp1$temp.water <- na_kalman(cleaning.temp1$temp.water)
...
MOOS.comb.in <- MOOS.comb.in %>% filter(datetimeAK >= "2020-06-15 17:30:00" & datetimeAK < "2020-10-13 23:45:00")
...
ts_2020.moos <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2020-06-15 17:30"),ymd_hm("2020-10-13 23:30"), by = '15 mins')), tz = "America/Anchorage"))
...
clean <- MOOS.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new2 = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new2) %>% 
   filter(n()<48) %>% 
   select(-new2)
...
# clean$ODO.Psat <- na_kalman(clean$ODO.Psat, type = "level")
...
MOOS.comb.in <- MOOS.comb.in %>% filter(datetimeAK >= "2021-05-19 17:00:00" & datetimeAK < "2021-09-28 10:30:00")
...
ts_2021.moos <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2021-05-19 17:00"),ymd_hm("2021-09-28 10:15"), by = '15 mins')), tz = "America/Anchorage"))
...
#cut off at end
MOOS.comb.in <- MOOS.comb.in %>% filter(solar.time > "2021-05-25 16:15:00")
...
#linear fill
clean3 <- MOOS.comb.in %>% filter(as.character(datetimeAK)< "2021-06-27 11:00:00")
clean4 <- MOOS.comb.in %>% filter(as.character(datetimeAK) >"2021-07-01 12:00:00")

cleanTestFill <- MOOS.comb.in %>% filter(as.character(datetimeAK)>= "2021-06-27 11:00:00"& as.character(datetimeAK) <="2021-07-01 12:00:00")

cleanTestFill$depth <- na_kalman(cleanTestFill$depth,type = "level")
cleanTestFill$discharge <- na_kalman(cleanTestFill$discharge, type = "level")


MOOS.comb.in <- rbind(clean3, cleanTestFill, clean4)
...
clean %>% filter(solar.time>"2021-06-13"&solar.time<"2021-07-15") %>%  ggplot(aes(x = as.POSIXct(datetimeAK), y = discharge)) + geom_miss_point()
...
MOOS.comb.in <- MOOS.comb.in %>% filter(datetimeAK >= "2022-05-25 00:00:00" & datetimeAK < "2022-10-08 08:00:00")
...
ts_2022.moos <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2022-05-25 00:00"),ymd_hm("2022-10-08 07:45"), by = '15 mins')), tz = "America/Anchorage"))
...
clean3 <- clean %>% filter(as.character(datetimeAK)< "2022-07-08 10:45:00")
clean4 <- clean %>% filter(as.character(datetimeAK) >="2022-07-08 10:45:00")

clean3$DO.obs <- na_kalman(clean3$DO.obs)
clean4$DO.obs <- na_kalman(clean4$DO.obs, type = "level")

clean <- rbind(clean3,clean4)
...
FRCH.comb.in <- FRCH.comb.in %>% filter(datetimeAK >= "2019-04-29 14:15:00" & datetimeAK < "2019-10-10 09:15:00")
...
ts_2019.frch <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2019-04-29 22:30"),ymd_hm("2019-10-10 09:00"), by = '15 mins')), tz = "America/Anchorage"))
...
clean <- FRCH.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new) %>% 
   filter(n()<48) %>% 
...
FRCH.comb.in <- FRCH.comb.in %>% filter(datetimeAK >= "2020-06-11 14:00:00" & datetimeAK < "2020-10-13 23:45:00")
...
ts_2020.frch <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2020-06-11 14:00"),ymd_hm("2020-10-13 23:30"), by = '15 mins')), tz = "America/Anchorage"))
...
FRCH.comb.in <- FRCH.comb.in %>% filter(datetimeAK >= "2021-05-19 17:00:00" & datetimeAK < "2021-09-27 07:45:00")
FRCH.comb.in$datetimeAK <- as.POSIXct(FRCH.comb.in$datetimeAK, tz = "America/Anchorage")
FRCH.comb.in$solar.time <- as.POSIXct(FRCH.comb.in$solar.time, tz = "UTC")
...
ts_2021.frch <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2021-05-19 17:00"),ymd_hm("2021-09-27 07:30"), by = '15 mins')), tz = "America/Anchorage"))
...
FRCH.2021_comb_ts %>% ggplot(aes(x = as.POSIXct(datetimeAK), y = ODO.Psat)) + geom_miss_point()
...
#linear fill
clean3 <- FRCH.comb.in %>% filter(as.character(datetimeAK)< "2021-06-27 11:00:00")
clean4 <- FRCH.comb.in %>% filter(as.character(datetimeAK) >"2021-07-01 12:00:00")

cleanTestFill <- FRCH.comb.in %>% filter(as.character(datetimeAK)>= "2021-06-27 11:00:00"& as.character(datetimeAK) <="2021-07-01 12:00:00")

cleanTestFill$depth <- na_kalman(cleanTestFill$depth,type = "level")
cleanTestFill$discharge <- na_kalman(cleanTestFill$discharge, type = "level")


FRCH.comb.in <- rbind(clean3, cleanTestFill, clean4)
...
clean %>% ggplot(aes(x = as.POSIXct(datetimeAK), y = DO.obs)) + geom_miss_point()
 ...
 clean %>% filter(solar.time>"2021-06-20"&solar.time<"2021-07-03") %>%  ggplot(aes(x = as.POSIXct(datetimeAK), y = discharge)) + geom_miss_point()
...
FRCH.comb.in <- FRCH.comb.in %>% filter(datetimeAK >= "2022-06-04 12:15:00" & datetimeAK < "2022-10-10 10:00:00")
...
ts_2022.frch <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2022-06-04 12:15"),ymd_hm("2022-10-10 09:45"), by = '15 mins')), tz = "America/Anchorage"))
...
VAUL.comb.in <- VAUL.comb.in %>% filter(datetimeAK >= "2019-06-07 17:45:00" & datetimeAK < "2019-10-11 13:30:00")
...
ts_2019.vaul <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2019-06-07 17:45"),ymd_hm("2019-10-11 13:15"), by = '15 mins')), tz = "America/Anchorage"))
...
# clean <- VAUL.comb.in %>%
#    mutate(datetimeAK = lubridate::ymd_hms(datetimeAK)) %>%
#    group_by(datetimeAK, new = rleid(is.na(temp.water))) %>%
#    ungroup() %>%
#    group_by(temp.water,new) %>%
#    filter(n()<48) %>%
#    select(-new)
# # 
# # clean <- clean1 %>%
...
clean <- VAUL.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new) %>% 
   filter(n()<48) %>% 
...
cleaning.temp1 <- clean %>% filter(solar.time<="2019-09-15")
cleaning.temp2 <- clean %>% filter(solar.time>"2021-09-15")

cleaning.temp1$ODO.Psat <- na_kalman(cleaning.temp1$ODO.Psat, type = "level")
cleaning.temp2$ODO.Psat <- na_kalman(cleaning.temp2$ODO.Psat, type = "level")
...
VAUL.comb.in <- VAUL.comb.in %>% filter(datetimeAK >= "2020-06-05 16:00:00" & datetimeAK < "2020-10-04 23:45:00")
...
ts_2020.vaul <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2020-06-05 16:00"),ymd_hm("2020-10-04 23:30"), by = '15 mins')), tz = "America/Anchorage"))
...
VAUL.comb.in <- VAUL.comb.in %>% filter(datetimeAK >= "2021-05-10 17:15:00" & datetimeAK < "2021-09-27 16:15:00")
...
ts_2021.vaul <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2021-05-10 17:15"),ymd_hm("2021-09-27 16:15"), by = '15 mins')), tz = "America/Anchorage"))
VAUL.comb.in$datetimeAK <- as.POSIXct(VAUL.comb.in$datetimeAK)
...
vaul.comb.in <- vaul.comb.in %>% filter(datetimeAK >= "2022-08-09 13:00:00" & datetimeAK < "2022-10-11 14:00:00")
...
ts_2022.vaul <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2022-08-09 13:00"),ymd_hm("2022-10-11 13:45"), by = '15 mins')), tz = "America/Anchorage"))
...
STRT.comb.in <- STRT.comb.in %>% filter(datetimeAK >= "2019-05-21 14:45:00" & datetimeAK < "2019-10-12 23:45:00")
...
ts_2019.strt <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2019-05-21 14:45"),ymd_hm("2019-10-12 23:30"), by = '15 mins')), tz = "America/Anchorage"))
...
clean <- STRT.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new) %>% 
   filter(n()<48) %>% 
...
STRT.comb.in <- STRT.comb.in %>% filter(datetimeAK >= "2020-06-17 16:45:00" & datetimeAK < "2020-10-07 23:45:00")
...
ts_2020.strt <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2020-06-17 16:45"),ymd_hm("2020-10-07 23:30"), by = '15 mins')), tz = "America/Anchorage"))
STRT.comb.in$datetimeAK <- as.POSIXct(STRT.comb.in$datetimeAK)
...
STRT.comb.in <- STRT.comb.in %>% filter(datetimeAK >= "2021-05-19 17:00:00" & datetimeAK < "2021-09-28 10:30:00")
...
ts_2021.strt <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2021-05-19 17:00"),ymd_hm("2021-09-28 10:25"), by = '15 mins')), tz = "America/Anchorage"))
STRT.comb.in$datetimeAK <- as.POSIXct(STRT.comb.in$datetimeAK)
...
#linear fill
clean3 <- STRT.comb.in %>% filter(as.character(datetimeAK)< "2021-06-27 11:00:00")
clean4 <- STRT.comb.in %>% filter(as.character(datetimeAK) >"2021-07-01 12:00:00")

cleanTestFill <- STRT.comb.in %>% filter(as.character(datetimeAK)>= "2021-06-27 11:00:00"& as.character(datetimeAK) <="2021-07-01 12:00:00")

cleanTestFill$depth <- na_kalman(cleanTestFill$depth,type = "level")
cleanTestFill$discharge <- na_kalman(cleanTestFill$discharge, type = "level")


STRT.comb.in <- rbind(clean3, cleanTestFill, clean4)
...
ts_2022.strt <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2022-06-03 00:15"),ymd_hm("2022-10-08 13:45"), by = '15 mins')), tz = "America/Anchorage"))
...
ggplot() +
  geom_point(data=clean, aes(x=datetimeAK,y=DO.obs))+
  geom_point(data=clean, aes(x=datetimeAK,y=discharge/500), color = "dark blue")+
  scale_y_continuous(sec.axis = sec_axis(trans = ~.*500)) +  theme(text = element_text(size=10))+scale_x_datetime(breaks = "3 days")+theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
POKE.comb.in <- POKE.comb.in %>% filter(datetimeAK >= "2019-05-11 12:45:00" & datetimeAK < "2019-10-14 00:00:00")
...
ts_2019.poke <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2019-05-11 12:45"),ymd_hm("2019-10-13 23:45"), by = '15 mins')), tz = "America/Anchorage"))
...
cleaning.DO1 <-  clean %>% filter(solar.time>="2019-05-20"&solar.time<="2019-08-01")
cleaning.DO2 <- clean %>% filter(solar.time<"2019-05-20")
cleaning.DO3 <- clean %>% filter(solar.time>"2019-08-01")

cleaning.DO1$DO.obs <- na_kalman(cleaning.DO1$DO.obs, type = "level")
cleaning.DO2$DO.obs <- na_kalman(cleaning.DO2$DO.obs)
cleaning.DO3$DO.obs <- na_kalman(cleaning.DO3$DO.obs, type = "level")


clean <- rbind(cleaning.DO2,cleaning.DO1 , cleaning.DO3)
...
POKE.comb.in <- POKE.comb.in %>% filter(datetimeAK >= "2020-06-04 14:30:00" & datetimeAK < "2020-10-08 23:45:00")
...
ts_2020.poke <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2020-06-04 14:30"),ymd_hm("2020-10-08 23:30"), by = '15 mins')), tz = "America/Anchorage"))
POKE.comb.in$datetimeAK <- as.POSIXct(POKE.comb.in$datetimeAK)
...
clean <- POKE.comb.in %>% select(X, datetimeAK, temp.water, ODO.Psat, ODO.Ploc, DO.obs, discharge, depth, light, DO.sat.EXO, solar.time) %>% 
   group_by(datetimeAK, new = rleid(is.na(DO.obs))) %>% 
   ungroup() %>% 
   group_by(DO.obs,new) %>% 
   filter(n()<48) %>% 
...
POKE.comb.in <- POKE.comb.in %>% filter(datetimeAK >= "2021-05-10 17:00:00" & datetimeAK < "2021-08-10 19:15")
...
ts_2021.poke <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2021-05-10 17:00"),ymd_hm("2021-08-10 19:00"), by = '15 mins')), tz = "America/Anchorage"))
POKE.comb.in$datetimeAK <- as.POSIXct(POKE.comb.in$datetimeAK)
...
ts_2022.poke <- data.frame(datetimeAK = force_tz(as.POSIXct(seq(ymd_hm("2022-05-18 00:00"),ymd_hm("2022-10-07 10:00"), by = '15 mins')), tz = "America/Anchorage"))
