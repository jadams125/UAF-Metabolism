---
title: "2019_metab_8000BI_1500Saved"
author: "Jacob Adams"
date: "2023-01-09"
...
data.strt.mm.all <- read.csv(here("outputs", "clean.strt.full"))
...
save(mm.test.strt, file = here("Outputs", "stuart2019-Run_2023-01-09.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2019-Run_2023-01-09.csv"))
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2019-Run_2023-01-09.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2019-Run_2023-01-09.csv"))
...
data.vaul.mm.all <- read.csv(here("outputs", "vault.comb.readyforMetab.new.clean.csv"))

data.vaul.mm.all <- data.vaul.mm.all %>% filter(solar.time < "2019-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2019-Run_2023-01-09.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2019-Run_2023-01-09.csv"))
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("Vault 2019")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
data.frch.mm.all <- read.csv(here("outputs", "french.comb.readyforMetab.new.clean.csv"))

data.frch.mm.all <- data.frch.mm.all %>% filter(solar.time < "2019-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2019-Run_2023-01-09.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2019-Run_2023-01-09.csv"))
...
gpp <- ggplot(data=fit.daily, aes(x=date, y=GPP_mean)) + geom_point(color = "chartreuse4") + geom_errorbar(aes(ymin=GPP_mean-GPP_sd, ymax=GPP_mean+GPP_sd), width=.2, position=position_dodge(0.05), color = "chartreuse4") + theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank() )+ labs(y = expression(paste("GPP (g ", O[2] ," ", m^2, d^-1, ")")))+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank())+ theme(panel.border = element_rect(colour = "black", fill=NA, size=2))+theme( axis.title.y = element_text(size = 20))+theme(axis.text.y=element_text(size=20))+ ggtitle("French 2019")+theme(plot.title = element_text(hjust = 0.5))+theme(plot.title = element_text(size = 40, face = "bold")) +ylim(0, max(fit.daily$GPP_mean))
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2019-Run_2023-01-09.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2019-Run_2023-01-09.csv"))
...
data.strt.mm.all <- data.strt.mm.all %>% filter(solar.time > "2019-12-30 04:13:57"&solar.time < "2020-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2020-Run_2023-01-09.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2020-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "strt2020.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.poke.mm.all <- data.poke.mm.all %>% filter(solar.time > "2019-12-30 04:13:57"&solar.time < "2020-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2020-Run_2023-01-09.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2020-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2020.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.vaul.mm.all <- data.vaul.mm.all %>% filter(solar.time > "2019-12-30 04:13:57"&solar.time < "2020-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2020-Run_2023-01-09.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2020-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2020.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.frch.mm.all <- data.frch.mm.all %>% filter(solar.time > "2019-12-30 04:13:57"&solar.time < "2020-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2020-Run_2023-01-09.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2020-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2020.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.moos.mm.all <- data.moos.mm.all %>% filter(solar.time > "2019-12-30 04:13:57"&solar.time < "2020-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2020-Run_2023-01-09.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2020-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2019 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2020.pdf", fig2019, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.strt.mm.all <- data.strt.mm.all %>% filter(solar.time > "2020-12-30 04:13:57"&solar.time < "2021-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2021-Run_2023-01-09.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2021-Run_2023-01-09.csv"))
...
ggsave(path = here("outputs"), file = "strt2021.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.poke.mm.all <- data.poke.mm.all %>% filter(solar.time > "2021-01-15 04:13:57"&solar.time < "2021-11-04 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2021-Run_2023-01-09.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2021-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2021.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.vaul.mm.all <- data.vaul.mm.all %>% filter(solar.time > "2020-12-30 04:13:57"&solar.time < "2021-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2021-Run_2023-01-09.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2021-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2021.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.frch.mm.all <- data.frch.mm.all %>% filter(solar.time > "2020-12-30 04:13:57"&solar.time < "2021-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2021-Run_2023-01-09.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2021-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2021.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.moos.mm.all <- data.moos.mm.all %>% filter(solar.time > "2020-12-30 04:13:57"&solar.time < "2021-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2021-Run_2023-01-09.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2021-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2020 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2021.pdf", fig2020, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.strt.mm.all <- data.strt.mm.all %>% filter(solar.time > "2021-12-30 04:13:57"&solar.time < "2022-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.strt, file = here("Outputs", "stuart2022-Run_2023-01-09.RData"))
# 
fit.strt <- get_fit(mm.test.strt)
fit.daily <- fit.strt$daily
write.csv(fit.daily, here("outputs", "stuart2022-Run_2023-01-09.csv"))
...
ggsave(path = here("outputs"), file = "strt2022.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.poke.mm.all <- data.poke.mm.all %>% filter(solar.time > "2022-01-15 04:13:57"&solar.time < "2022-11-04 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.poke, file = here("Outputs", "poker2022-Run_2023-01-09.RData"))
# 
fit.poke <- get_fit(mm.test.poke)
fit.daily <- fit.poke$daily
write.csv(fit.daily, here("outputs", "poker2022-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "poke2022.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.vaul.mm.all <- data.vaul.mm.all %>% filter(solar.time > "2021-12-30 04:13:57"&solar.time < "2022-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.vaul, file = here("Outputs", "vault2022-Run_2023-01-09.RData"))
# 
fit.vaul <- get_fit(mm.test.vaul)
fit.daily <- fit.vaul$daily
write.csv(fit.daily, here("outputs", "vault2022-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "vaul2022.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.frch.mm.all <- data.frch.mm.all %>% filter(solar.time > "2021-12-30 04:13:57"&solar.time < "2022-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.frch, file = here("Outputs", "french2022-Run_2023-01-09.RData"))
# 
fit.frch <- get_fit(mm.test.frch)
fit.daily <- fit.frch$daily
write.csv(fit.daily, here("outputs", "french2022-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "frch2022.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
...
data.moos.mm.all <- data.moos.mm.all %>% filter(solar.time > "2021-12-30 04:13:57"&solar.time < "2022-12-30 04:13:57")
...
# 
difftime(endTime, startTime)
save(mm.test.moos, file = here("Outputs", "moose2022-Run_2023-01-09.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moose2022-Run_2023-01-09.csv"))
...
grid.draw(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF, panG,size="max"))
fig2021 <- arrangeGrob(rbind(panA, panB,panK600, panC, panD,panE,panp2,panF,panG, size="max"))
ggsave(path = here("outputs"), file = "moos2022.pdf", fig2021, width = 30, height = 55, units = "in", limitsize = FALSE)
