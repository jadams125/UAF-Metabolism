...
bayes_specs <- specs(bayes_name, 
                     burnin_steps=10000, saved_steps=3500, n_cores=4, n_chains = 4, GPP_daily_lower = 0, ER_daily_upper = 0
)
...
data.moos.mm.all <- data.moos.mm.all %>% filter(solar.time >= "2019-05-01 04:13:57" & solar.time < "2019-11-11 04:13:57")
...
save(mm.test.moos, file = here("Outputs", "moos.2019.2.new.RData"))
# 
fit.moos <- get_fit(mm.test.moos)
fit.daily <- fit.moos$daily
write.csv(fit.daily, here("outputs", "moos.2019.2.new.full.csv"))
...
write.csv(model_data, here("outputs", "moos.2019.2.new.model_data.csv"))
