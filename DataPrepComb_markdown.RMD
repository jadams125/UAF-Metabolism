...
SondeData2019 <- read_csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_2019/processed_sensor_dat/SUNA.EXO.int.corr.lab_2019.csv")
...
exo.2020 <- read_csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_2020/processed_sensor_dat/SUNA.EXO.int.corr.lab_2020.csv")
...
exo.2021 <- read_csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_2021/processed_sensor_dat/SUNA.EXO.int.corr.lab_2021.csv")
...
exo.2022 <- read_csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_2022/processed_sensor_dat/SUNA.EXO.int.corr.lab_2022.csv")
...
vaul.exo.2022 <- vaul.exo.2022 %>% select(datetimeAK, Temp.C.int, ODO.mgL.mn, ODO.Psat.mn.adj, ODO.Ploc.mn.adj, site.ID) %>% dplyr::rename(ODO.mgL = ODO.mgL.mn, ODO.Psat = ODO.Psat.mn.adj, ODO.Ploc = ODO.Ploc.mn.adj, Temp.C = Temp.C.int)
...
Q_2019 <- read.csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_Discharge/Predicted_Discharge/2019/Predicted_Q_2019_gapfill.csv")
Q_2019$DateTime <-  force_tz(as.POSIXct(ymd_hms(Q_2019$DateTime)), tz = "America/Anchorage")
#### Breaking up into sites ####
POKE_Q_2019 <- Q_2019 %>% select(DateTime, POKE.Q.int) %>% rename(Q = POKE.Q.int)
POKE_Q_2019$Site <- "POKE"

MOOS_Q_2019 <- Q_2019 %>% select(DateTime, MOOS) %>% rename(Q = MOOS)
MOOS_Q_2019$Site <- "MOOS"

STRT_Q_2019 <- Q_2019 %>% select(DateTime, STRT) %>% rename(Q = STRT)
STRT_Q_2019$Site <- "STRT"

VAUL_Q_2019 <- Q_2019 %>% select(DateTime, VAUL) %>% rename(Q = VAUL)
VAUL_Q_2019$Site <- "VAUL"


FRCH_Q_2019 <- Q_2019 %>% select(DateTime, FRCH) %>% rename(Q = FRCH)
FRCH_Q_2019$Site <- "FRCH"
...
Q_2021 <- read.csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_Discharge/Predicted_Discharge/2021/Predicted_Q_2021_gapfill.csv")
Q_2021$DateTime <-  force_tz(as.POSIXct(ymd_hms(Q_2021$DateTime)), tz = "America/Anchorage")

#### Breaking up into sites ####
POKE_Q_2021 <- Q_2021 %>% select(DateTime, POKE.Q.int) %>% rename(Q = POKE.Q.int)
POKE_Q_2021$Site <- "POKE"

MOOS_Q_2021 <- Q_2021 %>% select(DateTime, MOOS.Q.int) %>% rename(Q = MOOS.Q.int)
MOOS_Q_2021$Site <- "MOOS"

STRT_Q_2021 <- Q_2021 %>% select(DateTime, STRT.Q.int) %>% rename(Q = STRT.Q.int)
STRT_Q_2021$Site <- "STRT"

VAUL_Q_2021 <- Q_2021 %>% select(DateTime, VAUL.Q.int) %>% rename(Q = VAUL.Q.int)
VAUL_Q_2021$Site <- "VAUL"


FRCH_Q_2021 <- Q_2021 %>% select(DateTime, FRCH.Q.int) %>% rename(Q = FRCH.Q.int)
FRCH_Q_2021$Site <- "FRCH"
...
Q_2022 <- read.csv("C:/Users/jacob/OneDrive - University of Alaska/GitHub/DoD_Discharge/Predicted_Discharge/2022/Predicted_Q_2022_gapfill.csv")

Q_2022 <- Q_2022 %>% rename(DateTime = DateTimeAK)
Q_2022$DateTime <-  force_tz(as.POSIXct(ymd_hms(Q_2022$DateTime)), tz = "America/Anchorage")

#### Breaking up into sites ####
POKE_Q_2022 <- Q_2022 %>% select(DateTime, POKE.Q.int) %>% rename(Q = POKE.Q.int)
POKE_Q_2022$Site <- "POKE"

MOOS_Q_2022 <- Q_2022 %>% select(DateTime, MOOS.Q.int) %>% rename(Q = MOOS.Q.int)
MOOS_Q_2022$Site <- "MOOS"

STRT_Q_2022 <- Q_2022 %>% select(DateTime, STRT.Q.int) %>% rename(Q = STRT.Q.int)
STRT_Q_2022$Site <- "STRT"

VAUL_Q_2022 <- Q_2022 %>% select(DateTime, VAUL) %>% rename(Q = VAUL)
VAUL_Q_2022$Site <- "VAUL"


FRCH_Q_2022 <- Q_2022 %>% select(DateTime, FRCH) %>% rename(Q = FRCH)
FRCH_Q_2022$Site <- "FRCH"
...
write.csv(poke.depth, here("outputs","pokeMeanDepth.csv"))
...
write.csv(vaul.depth, here("outputs","vaulMeanDepth.csv"))
...
write.csv(moos.depth, here("outputs","moosMeanDepth.csv"))
...
write.csv(frch.depth, here("outputs","frchMeanDepth.csv"))
...
write.csv(strt.depth, here("outputs","strtMeanDepth.csv"))
...
pdf(file = "C:/Users/jacob/OneDrive - University of Alaska/GitHub/UAF-Metabolism/Plots/FRCH_comb.2022.pdf", height= 8.5)
...
pdf(file = "C:/Users/jacob/OneDrive - University of Alaska/GitHub/UAF-Metabolism/Plots/MOOS_comb.2022.pdf", height= 8.5)
...
pdf(file = "C:/Users/jacob/OneDrive - University of Alaska/GitHub/UAF-Metabolism/Plots/STRT_comb.2022.pdf", height= 8.5)
...
pdf(file = "C:/Users/jacob/OneDrive - University of Alaska/GitHub/UAF-Metabolism/Plots/POKE_comb.2022.pdf", height= 8.5)
...
pdf(file = "C:/Users/jacob/OneDrive - University of Alaska/GitHub/UAF-Metabolism/Plots/VAUL_comb.2022.pdf", height= 8.5)
